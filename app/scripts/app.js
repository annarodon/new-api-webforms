    ...
    .config(function($translateProvider) {
        $translateProvider
            .translations('es', {
                ...
                ACCEPTO_CONDICIONS_I_POLITICA_PRIVACITAT: 'Acepto las <strong><a target="_blank" href="#">condiciones generales del contrato</a></strong> y la <strong><a target="_blank" href="#">política de privacidad</a></strong>',
                ...
                ACCEDINT_SERVEI_PAGAMENT: 'Accediendo al servicio de pago',
                ...
                CARREGAR_DADES_SOCI_VINCULAT: 'Cargar datos del/la socio/a viculado/a',
                SOCI_VINCULAT: 'Socio/a vinculado/a',
                NO_TROBEM_CAP_SOCI_VINCULAT: 'No se ha encontrado ningún/a socio/a vinculado/a a estos datos!',
                ...
                HELP_POPOVER_OPTIONAL_INFO: 'No es obligatoria, pero sí muy recomendable',
                ...
                SI: 'Sí',
                NO: 'No',
                HELP_POPOVER_OWNER: '¿Comparado con su contracto actual, en el nuevo contrato quieres poner a otra persona de titular?',
                EL_TITULAR_ES: 'El titular es',
                EL_TITULAR_ES_SOCI_VINCULAT_AL_CONTRACTE: '¿El titular es socio/a vinculado/a al contrato?',
                ...
                ELS_SOCIS_I_SOCIES_QUE_HO_DESITGIN_PODEN_REALITZAR_UN_DONATIU_VOLUNTARI: 'Los socios y socias que lo deseen puede realizar un donativo voluntario',
